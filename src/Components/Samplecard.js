          ...
          >
            <div className='m-2 p-2 w-80 h-auto cursor-pointer hover:shadow-xl transition-shadow duration-300  rounded-lg overflow-hidden shadow-md relative'>
              ...
              <Link to={`/productdetail/${i.id}`}>
                <img src={dynamicimg ? 'https://www.tatasimplybetter.com/cdn/shop/files/02_55327725-425c-47ca-9bfc-95174cfcec22_2048x2048.jpg?v=1696853707' : 'https://www.tatasimplybetter.com/cdn/shop/files/01_8c295e30-011b-4eb1-ab78-eb9e556d783b_2048x2048.jpg?v=1696853707'} className='w-full h-60 object-cover rounded-lg border' alt={i.attributes.name} onMouseEnter={() => handlemouseenter(i.id)} onMouseLeave={()=>handlemouseleave(i.id)} />
                <div className='p-4'>
