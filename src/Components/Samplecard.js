...
export const Samplecard = () => {
  ...
  return (
    <>
      <div className='flex flex-wrap justify-center mb-10 bg-gray-100 '>
        ...
        {data?.data.map((i) => (
          ...
          >
            ...
            <div className='m-2 p-2 w-64 h-[340px]  cursor-pointer hover:shadow-xl transition-shadow duration-300  rounded-lg overflow-hidden shadow-md relative'>
              {i.attributes.stock   ? (
